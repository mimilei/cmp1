...
#define VS1053_DCS   A5     // VS1053 Data/command select pin (output)
#define CARDCS   A2     // Card chip select pin
#define VS1053_DREQ   A4     // VS1053 Data request, ideally an Interrupt pin
...
//  }
  ...
  Serial.println(("Playing full track 001"));
  musicPlayer.playFullFile("welcome.mp3");
